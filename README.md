...
使用另行上传的default.conf替换原版后，可直连 nyaa.si / acg.rip / bangumi.moe / acgnx.se / ~~谷歌翻译(仅API)~~(不稳定) / apk.support / searx.be / reddit / twitch(需要先用其他手段登录) / apkmirror / sci-hub / v2ex / z-lib 等，不保证一定能用。
